"""Telco Network Operations Center — US mobile 5G/4G core, billing, SMS, CDN, voice, and IoT across AWS, GCP, and Azure."""
...
class TelcoScenario(BaseScenario):
    """Telco telecom NOC platform with 9 services and 20 fault channels."""
    ...
    def scenario_name(self) -> str:
        return "Telco Network Operations Center"

    @property
    def scenario_description(self) -> str:
        return (
            "US mobile telecom NOC managing 5G/4G mobile core, real-time billing, "
            "SMS messaging, CDN video streaming, VoIP, and IoT connectivity across "
            "national metro markets and tens of millions of subscribers."
        )
        ...
        return {
            ...
            3: {
                ...
                "stack_trace": (
                    ...
                    "mediation_host=telco-cdr-med-01 period=last_15min\n"
                    "--- QUEUE METRICS ---\n"
            ...
            4: {
                ...
                "stack_trace": (
                    ...
                    "peer=pcef-01.telco imsi={imsi} session={session_id}\n"
                    "--- DIAMETER MESSAGE ---\n"
            ...
            5: {
                ...
                "stack_trace": (
                    ...
                    " location_impossible    TRIGGER  NYC→SEA 8min impossible travel\n"
            ...
            6: {
                ...
                "stack_trace": (
                    "=== SMSC QUEUE STATUS ===\n"
                    "smsc_host=telco-smsc-01 period=last_5min\n"
                    "--- QUEUE METRICS ---\n"
            ...
            7: {
                ...
                "stack_trace": (
                    ...
                    "server=telco-smpp-01:2775 system_id={smpp_system_id}\n"
                    "--- BIND ATTEMPT ---\n"
            ...
            8: {
                ...
                "investigation_notes": (
                    ...
                    "3. Inspect SSO (Single Sign-On) federation — if the operator's SAML IdP certificate "
                    "expires or the metadata endpoint is unreachable, SSO-authenticated users cannot "
                    "log in. Check: openssl s_client -connect sso.telco.example:443 | grep 'notAfter'\n"
                ...
                "stack_trace": (
                    ...
                    "portal=my.telco.example period=last_5min\n"
                    "--- AUTH METRICS ---\n"
                    " METRIC              VALUE    THRESHOLD STATUS\n"
            ...
            9: {
                ...
                "stack_trace": (
                    ...
                    "gateway=api.telco.example client_id={api_client}\n"
                    "--- RATE ANALYSIS ---\n"
            ...
            10: {
                ...
                "investigation_notes": (
                    ...
                    "origin load multiplies by edge PoP count (48 PoPs in US). Enable shield "
            ...
            11: {
                ...
                "investigation_notes": (
                    ...
                    "2. Review live event priority queue — live events (Telco Sports, Telco TV) "
                ...
                "stack_trace": (
                    ...
                    "farm=telco-transcode-gcp-01 period=last_15min\n"
                    "--- WORKER STATUS ---\n"
                    " WORKER        STATUS  CURRENT_JOB            GPU\n"
                    " gpu-worker-01 BUSY    live-sports-4k     92%\n"
                    " gpu-worker-02 BUSY    live-tv-hd         88%\n"
            ...
            12: {
                ...
                "stack_trace": (
                    ...
                    "cluster=telco-analytics-gcp period=last_5min\n"
                    "--- KAFKA CONSUMER LAG ---\n"
                    " GROUP=noc-analytics\n"
                    " TOPIC                    LAG      STATUS\n"
            ...
            13: {
                ...
                "stack_trace": (
                    ...
                    "dpi_cluster=telco-dpi-gcp-01 period=last_10min\n"
            ...
            14: {
                ...
                "stack_trace": (
                    ...
                    "proxy=telco-sbc-azure-01 period=last_5min\n"
                    "--- TRUNK METRICS ---\n"
            ...
            15: {
                ...
                "stack_trace": (
                    ...
                    "p_cscf=telco-pcscf-azure-01 period=last_5min\n"
            ...
            16: {
                ...
                "stack_trace": (
                    "=== MQTT BROKER STATUS ===\n"
                    "broker=telco-mqtt-azure-01 period=last_10min\n"
                    "--- CONNECTION METRICS ---\n"
                    " METRIC              VALUE      THRESHOLD STATUS\n"
            ...
            17: {
                ...
                "investigation_notes": (
                    ...
                    "with valid certs. Test: openssl ocsp -issuer ca.pem -cert device.pem -url http://ocsp.telco.iot\n"
                ...
                "stack_trace": (
                    ...
                    "registry=telco-iot-registry period=last_6h\n"
                    "--- CERTIFICATE STATUS ---\n"
                    " STATUS          COUNT    PCT\n"
                    " VALID            4.2M    82%\n"
            ...
            18: {
                ...
                "stack_trace": (
                    ...
                    "host=telco-alertmanager-azure period=last_10min\n"
                    "--- ALERT METRICS ---\n"
                    " METRIC               VALUE    NORMAL  STATUS\n"
            ...
            19: {
                ...
                "stack_trace": (
                    ...
                    "router=telco-core-azure-01 period=last_30min\n"
                    "--- BGP PEER STATUS ---\n"
            ...
            20: {
                ...
                "investigation_notes": (
                    ...
                    "services fail. Check: dig @dns-primary.telco +time=2 google.com\n"
                    ...
                    "dig +dnssec +cd telco.example — if CD (Checking Disabled) resolves but normal fails, DNSSEC misconfiguration.\n"
    ...
    def hosts(self) -> list[dict[str, Any]]:
        return [
            ...
            {
                "host.name": "telco-gcp-digital-01",
                "host.id": "telco-gcp-digital-01-id",
                "host.arch": "amd64",
                "host.type": "n2-standard-32",
                "host.image.id": "projects/telco-digital/images/ubuntu-2204",
                ...
                "cloud.account.id": "telco-digital-prod",
                "cloud.instance.id": "telco-gcp-digital-01-id",
                "cpu_count": 32,
                "memory_total_bytes": 137438953472,
                "disk_total_bytes": 549755813888,
            },
            {
                "host.name": "telco-azure-ops-01",
                "host.id": "telco-azure-ops-01-id",
                "host.arch": "amd64",
                ...
                "cloud.account.id": "telco-azure-prod",
                "cloud.instance.id": "telco-azure-ops-01-id",
                "cpu_count": 32,
                "memory_total_bytes": 137438953472,
                "disk_total_bytes": 549755813888,
            },
    ...
    def theme(self) -> UITheme:
        return UITheme(
            ...
            gradient_accent="linear-gradient(135deg, #E20074 0%, #F472B6 100%)",
            dashboard_title="Telco NOC — Magenta Operations",
            chaos_title="Network Fault Simulator",
            landing_title="Telco Network Operations Center",
    ...
    def agent_config(self) -> dict[str, Any]:
        return {
            "id": "telco-noc-analyst",
            "name": "Telco NOC Analyst",
            "system_prompt": (
                "You are the Telco NOC Analyst AI, an expert in US mobile telecommunications "
                ...
                "SIP/VoIP infrastructure. You support a national mobile operator with tens of millions of "
                "subscribers across US metro markets. Your role is to rapidly investigate network incidents, "
                "correlate telemetry from 9 microservices across AWS, GCP, and Azure, identify root causes, "
    ...
    def assessment_tool_config(self) -> dict[str, Any]:
        return {
            ...
            "description": (
                "Assess the operational impact of the current network incident on Telco subscribers. "
    ...
    def knowledge_base_docs(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "5G SA Core Architecture — National Mobile",
                "content": (
                    "the operator's 5G Standalone (SA) core uses a cloud-native architecture with AMF, SMF, UPF, "
            ...
            },
            {
                ...
                "content": (
                    "The operator uses an Online Charging System (OCS) for prepaid subscribers connected via "
            ...
            },
            {
                ...
                "content": (
                    "National Mobile operates regional SMSCs connected via SMPP v3.4 on TCP port 2775 (plain) "
            ...
            },
            {
                ...
                "content": (
                    "The My Account portal (my.telco.example, mi.telco.com.co, etc.) uses OAuth2/OIDC via Okta "
            ...
            {
                "title": "CDN and Video Streaming — Telco TV and Sports",
                "content": (
                    "Telco TV and Sports use a multi-CDN strategy with 48 PoPs across US. "
            ...
            },
            {
                ...
                "content": (
                    "the operator's network analytics stack ingests IPFIX/NetFlow v9 from 2,400 routers and "
            ...
            },
            {
                ...
                "content": (
                    "Voice infrastructure uses IMS (IP Multimedia Subsystem) with P-CSCF, I-CSCF, "
            ...
            },
            {
                ...
                "content": (
                    "Telco IoT Connect manages 5.2M devices across smart meters, industrial sensors, "
                    ...
                    "the operator's PKI (2-tier CA). Certificate lifetime: 2 years for fixed devices, 1 year for mobile. "
            ...
            {
                "title": "BGP and Core Routing — National Mobile Backbone",
                "content": (
                    "the operator's US backbone uses BGP (iBGP + eBGP) with MPLS transport. "
            ...
            },
            {
                ...
                "content": (
                    "Telco NOC operates 24/7 with Tier 1/2/3 escalation. Severity: P1 (<15min response), "
                    ...
                    "Runbooks are stored in Elastic Knowledge Base (index: telco-knowledge-base). "
            ...
            },
            {
                ...
                "content": (
                    ...
                    "Primary DNS: telco-dns-cluster-01 (AWS). Secondary: telco-dns-cluster-02 (AWS). "
                    ...
                    "DHCP DNS option: 10.64.0.1 (primary), 10.64.1.1 (secondary)."
                ),
            },
            {
                "title": "Fraud Detection — Real-Time Charging and SIM Swap",
                "content": (
                    "the operator's fraud system monitors for: premium rate fraud (IPRN), SIM swap attacks, "
            ...
            },
            {
                ...
                "content": (
                    ...
                    "Failover procedure: pcef-cli set ocs-primary=ocs-b.telco.internal "
                    ...
                    "ARPU US prepaid: $0.18/hour data. For a 1M subscriber outage: $3,000/min revenue impact."
                ),
            },
            {
            ...
            },
            {
                ...
                "content": (
                    "Self-care API rate limits by client_id (OAuth2 client credential). "
            ...
            },
            {
                ...
                "content": (
                    "Telco TV and Sports transcoding runs on GCP with NVIDIA T4 GPUs (NVENC). "
                    "Encoding profiles: H.264 (360p, 480p, 720p, 1080p), H.265 (1080p, 4K). "
                    "Live priority queue: channels SPORTS1-4 and TV-HD preempt all VOD jobs. "
                    ...
                    "DRM signing key server: drm.telco.internal:8443. SLA: <500ms signing latency. "
            ...
            },
            {
                ...
                "content": (
                    ...
                    "4. Regulatory: telecom regulators (FCC / state PUCs) require notification "
    ...
    def get_service_classes(self) -> list[type]:
        from scenarios.telco.services.mobile_core import MobileCoreService
        from scenarios.telco.services.billing_engine import BillingEngineService
        from scenarios.telco.services.sms_gateway import SmsGatewayService
        from scenarios.telco.services.customer_portal import CustomerPortalService
        from scenarios.telco.services.content_delivery import ContentDeliveryService
        from scenarios.telco.services.network_analytics import NetworkAnalyticsService
        from scenarios.telco.services.voice_platform import VoicePlatformService
        from scenarios.telco.services.iot_connect import IotConnectService
        from scenarios.telco.services.noc_dashboard import NocDashboardService
    ...
    def get_fault_params(self, channel: int) -> dict[str, Any]:
        ...
        params = {
            ...
            "ocs_host": f"ocs-{rng.choice(['a','b'])}.telco.internal",
            ...
            "dns_resolver": rng.choice(["telco-dns-01.aws", "telco-dns-02.aws"]),
    ...
    def get_trace_attributes(self, service_name: str, rng) -> dict:
        market = rng.choice(["NYC", "DFW", "SEA", "ATL", "CHI", "LAX", "DEN", "MIA"])
        return {
            "telco.country": "US",
            "telco.market": market,
            "telco.region": f"US-{market}",
            "telco.network_type": rng.choice(["5G-SA", "LTE", "5G-NSA"]),
        }

    def get_rca_clues(self, channel: int, service_name: str, rng) -> dict:
        clues = {
            1: {"telco.pdu.reject_cause": rng.choice(["ResourceLimitReached", "CongestionDetected"])},
            2: {"telco.lte.ho_cause": rng.choice(["UE_NOT_FOUND", "NO_RADIO_RESOURCES"])},
            3: {"telco.cdr.parse_error": "ASN1_SCHEMA_MISMATCH"},
            4: {"telco.ocs.result_code": rng.choice(["5012", "4012"])},
            5: {"telco.fraud.type": rng.choice(["SIM_SWAP", "IPRN_FRAUD"])},
            6: {"telco.smsc.overflow_class": rng.choice(["CLASS-1", "CLASS-2"])},
            7: {"telco.smpp.error": rng.choice(["ESME_RBINDFAIL", "ESME_RTHROTTLED"])},
            8: {"telco.portal.idp_status": rng.choice(["TIMEOUT", "ERROR_503"])},
            9: {"telco.api.throttle_reason": "RATE_LIMIT_EXCEEDED"},
            10: {"telco.cdn.purge_scope": "WILDCARD"},
            11: {"telco.cdn.gpu_worker_status": "FAILED"},
            12: {"telco.analytics.lag_cause": "FLINK_BACKPRESSURE"},
            13: {"telco.dpi.sig_staleness_days": str(rng.randint(8, 21))},
            14: {"telco.voice.trunk_failure": "CIC_EXHAUSTED"},
            15: {"telco.ims.storm_cause": "S_CSCF_RESTART"},
            16: {"telco.iot.broker_failure": "MAX_CONNECTIONS_REACHED"},
            17: {"telco.iot.cert_failure": "X509_EXPIRED"},
            18: {"telco.noc.correlation_disabled": "true"},
            19: {"telco.bgp.flap_cause": rng.choice(["BFD_FAILURE", "PHYSICAL_LINK_ERROR"])},
            20: {"telco.dns.rcode": rng.choice(["SERVFAIL", "TIMEOUT"])},
        }
        return clues.get(channel, {})

    def get_correlation_attribute(self, channel: int, is_error: bool, rng) -> dict:
        if is_error:
            return {"telco.fault_channel": str(channel)}
        return {}
